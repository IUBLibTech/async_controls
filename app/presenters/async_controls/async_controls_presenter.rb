  ...
  class AsyncControlsPresenter
    ...
    def actions
      ...
      when :staged
        [
          # Download link
          { title: I18n.t("async_controls.actions.download.title"),
            link: @storage_proxy_response["url"] },
          # Fixity link
          { title: I18n.t("async_controls.actions.fixity.title"),
            link: url_helpers.fixity_curation_concerns_file_set_path(@file_set_solr_document) },
          # Unstage link
          { title: I18n.t("async_controls.actions.unstage.title"),
            link: url_helpers.unstage_curation_concerns_file_set_path(@file_set_solr_document) }
        ]
      when :not_cached
        [
          # Stage link
          { title: I18n.t("async_controls.actions.stage.title"),
    ...
    def status_phrase
      status_phrases = {
        not_cached: I18n.t("async_controls.status_phrase.not_cached"),
        staging: I18n.t("async_controls.status_phrase.staging"),
        staged: I18n.t("async_controls.status_phrase.staged"),
        unstaging: I18n.t("async_controls.status_phrase.unstaging"),
        calculating_checksum: I18n.t("async_controls.status_phrase.calculating_checksum"),
        disabled: I18n.t("async_controls.status_phrase.disabled")
      }
